...
public class JavaMail {
	...
	public void javaMail(String from, String to, String subject, String message) {
		...
		auth = new SimpleAuth("nathyalmeidagyn@gmail.com", "nathyalmeida123");
		...
		try {
			 ...
			 * gmail
			 */
			tr.connect(mailSMTPServer, "nathyalmeidagyn@gmail.com", "nathyalmeida123");
