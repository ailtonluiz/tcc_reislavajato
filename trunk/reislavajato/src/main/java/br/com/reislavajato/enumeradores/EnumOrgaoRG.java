...
public enum EnumOrgaoRG implements Enumerador {
	...
	PC("PC", "Polícia Cívil"), SSP("SSP", "Secretaria da Segurança Pública"), SPTC("SPTC", "Superintendência da Polícia Técnico-Científica"), DGPC("DGPC", "Diretoria Geral da Polícia Civil");
